...
class ForestManager
{
	public:	
		 ...
		 *
		 **/
		ForestManager(PatchManager& pm_, std::vector<PartitionTree*>& forest_, int kNN, const ModelParams& param);
        ...
        int retrieveFromForest(std::vector<std::tuple<float, unsigned, float>>& indexes, unsigned pidx, bool excludeYourself = false);
		 ...
		 **/
		ModelParams get_params() { return params; };
